...
function hfmV70WeekSimulationModal() {
  ...
  const logRows = (sim.log || []).map(line => `<li>${hfmV68Html(line)}</li>`).join("") || "<li>Simulation startet...</li>";
  let interruptBox = "";
  if (news) {
